...
import Genetico.Funcoes;
import Genetico.Jogador;
...
public class Jugar extends JPanel implements Valores {
    ...
    Jogador[] jogadores = new Funcoes().preencheJogadores(new Jogador[10]); //preenche os cromossomos que irão agir como jogadores
    ...
    //Tronco[] troncos = {tronco1, tronco2, tronco3, tronco4, tronco5, tronco6, tronco7, tronco8};
    ...
    public Jugar() throws FileNotFoundException, IOException{     
        ...
        try {
            fondo1 = ImageIO.read(new File("src/imagenes/portadita3.jpg"));
            fondo2 = ImageIO.read(new File("src/imagenes/portadita3.jpg"));
            fondo3 = ImageIO.read(new File("src/imagenes/portadita3.jpg"));
            fondo4 = ImageIO.read(new File("src/imagenes/portadita3.jpg"));
            fondo5 = ImageIO.read(new File("src/imagenes/portadita3.jpg"));
            fondo6 = ImageIO.read(new File("src/imagenes/portadita3.jpg"));
            fondo7 = ImageIO.read(new File("src/imagenes/portadita3.jpg"));
            fondo8 = ImageIO.read(new File("src/imagenes/portadita3.jpg"));
            fondo9 = ImageIO.read(new File("src/imagenes/portadita3.jpg"));
        ...
        public void keyPressed(KeyEvent ke) {
            ...
            if(vida==1){
                ...
                if(ke.getKeyCode() == KeyEvent.VK_UP){
                    System.out.println("Apertei pra cima");
...
//                    validar();
    ...
    public void validar() {
            ...
            if(posy8>=t1.posy||posy8>=ti.posy){
                if(t1.posx<300&&t1.posx>-200||ti.posx<300&&ti.posx>-200){
                    if(tronco5.num==3){
                        vida=0;
                        //fx2.play();
                       // System.out.println("aqui morreu 1");
                    }
                }
            }
            ...
            //aqui também quando morre
            if(posy8>=t2.posy||posy8>=td.posy){
                if(t2.posx>300||td.posx>300){
                    if(tronco5.num==2){
                    vida=0;
                    //fx2.play();
                        System.out.println("aqui morreu 2");
                }
                }
            }
    ...
    /**
     * Faz o personagem se mexer para a direita
     */
    public void direita(){
        t1.posx = tstd;
        ti.posx = tstd;
    ...
    /**
     * Faz o personagem se mexer para a esquerda
     */
    ...
    public int verificaProximoTronco(int distancia){
         Tronco[] troncos = {tronco1, tronco2, tronco3, tronco4, tronco5, tronco6, tronco7, tronco8};
        return troncos[distancia].num;
    }
    
    public void iniciar(){
        while(vida == 1){
            boolean controlador=  true;
            if(verificaProximoTronco((int)jogadores[0].getDireita()) == 2){
                controlador = true;
            }
            else{
                if(verificaProximoTronco((int)jogadores[0].getEsquerda()) == 3){
                    controlador=false;
                }
            }
